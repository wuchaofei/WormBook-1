package com.jie.book.work.game;
...
public class MainView extends View {
	...
	public MainView(Context context, AttributeSet attrs, int defStyle) throws Exception {
	...
	private void createBitmapCells() {
		...
		for (int xx = 0; xx < bitmapCell.length; xx++) {
			bitmap1 = Bitmap.createBitmap(cellSize, cellSize, Bitmap.Config.ARGB_4444);
			Canvas canvas = new Canvas(bitmap1);
			drawDrawable(canvas, cellRectangle[xx], 0, 0, cellSize, cellSize);
			drawCellText(canvas, (int) Math.pow(2, xx), 0, 0);
			bitmapCell[xx] = new BitmapDrawable(resources, bitmap1);
		}
	}
	...
	private void createOverlays() {
		Resources resources = getResources();
		// Initalize overlays
		bitmap2 = Bitmap.createBitmap(endingX - startingX, endingY - startingY, Bitmap.Config.ARGB_4444);
		Canvas canvas = new Canvas(bitmap2);
		createEndGameStates(canvas, true, true);
		winGameContinueOverlay = new BitmapDrawable(resources, bitmap2);
		bitmap3 = Bitmap.createBitmap(endingX - startingX, endingY - startingY, Bitmap.Config.ARGB_4444);
		canvas = new Canvas(bitmap3);
		createEndGameStates(canvas, true, false);
		winGameFinalOverlay = new BitmapDrawable(resources, bitmap3);
		bitmap4 = Bitmap.createBitmap(endingX - startingX, endingY - startingY, Bitmap.Config.ARGB_4444);
		canvas = new Canvas(bitmap4);
		createEndGameStates(canvas, false, false);
		loseGameOverlay = new BitmapDrawable(resources, bitmap4);
	}
	...
	private void init(Context context) {
		...
		try {
			...
			TEXT_WHITE = resources.getColor(R.color.game_text_white);
			TEXT_BLACK = resources.getColor(R.color.game_text_black);
			TEXT_BROWN = resources.getColor(R.color.game_text_brown);
			this.setBackgroundColor(resources.getColor(R.color.game_background));
	...
	public void onDestroy() {
		BitmapUtil.recyledBitmapDrawable(loseGameOverlay);
		BitmapUtil.recyledBitmapDrawable(winGameContinueOverlay);
		BitmapUtil.recyledBitmapDrawable(winGameFinalOverlay);
		BitmapUtil.recyledBitmap(background);
		BitmapUtil.recyledBitmap(bitmap1);
		BitmapUtil.recyledBitmap(bitmap2);
		BitmapUtil.recyledBitmap(bitmap3);
		BitmapUtil.recyledBitmap(bitmap4);
	}
}
