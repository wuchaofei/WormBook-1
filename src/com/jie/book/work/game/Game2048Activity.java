...
import com.jie.book.work.utils.AdUtil;
...
public class Game2048Activity extends BaseActivity {
	...
	public static void luanch(Activity content) {
		...
		intent.setClass(content, Game2048Activity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_game2048);
		initUI();
		initData();
	}
	...
	protected void initUI() {
		view = (MainView) findViewById(R.id.gameView);
		new AdUtil(activity);
	}
