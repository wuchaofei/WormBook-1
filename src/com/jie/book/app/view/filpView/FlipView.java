package com.jie.book.app.view.filpView;

import com.jie.book.app.R;
import com.jie.book.app.view.filpView.Recycler.Scrap;
...
public class FlipView extends FrameLayout {
	...
	private void init() {
		...
		mShadePaint.setColor(Color.LTGRAY);
	...
	public void smoothFlipTo(int page) {
		...
		endFlip();
		mScroller.startScroll(0, start, 0, delta, 1000);
		invalidate();
	}
